...
exports.JWTSerializer = exports.SimpleStringProvider = exports.StandardJwtImplementation = void 0;
...
class JWTSerializer {
    ...
    async generateAccessToken(username) {
        ...
        return new Promise((resolve, reject) => {
            this.properties.jwt.sign({ username }, secretKey, { expiresIn: this.properties.expiresInSeconds }, (err, token) => {
                if (err) {
